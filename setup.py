...
def main():
    ...
    setup(
        name="ctodd-python-lib-mongodb",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with MongoDB"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-mongodb",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "Mongo", "mongodb", "mongos"],
        packages=packages,
